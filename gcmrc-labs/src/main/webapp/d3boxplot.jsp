...
<%!
private static final Logger log = LoggerFactory.getLogger("d3boxplot.jsp");
...
<html>
    <head>
		...
		<link type="text/css" rel="stylesheet" href="pages/d3boxplot/page.css" />
		...
		<jsp:include page="js/d3boxplot/d3boxplot.jsp">
			<jsp:param name="relPath" value="" />
			<jsp:param name="debug-qualifier" value="<%= development %>" />
		</jsp:include>
		...
		<script type="text/javascript" src="pages/d3boxplot/onReady.js"></script>
    </head>
    <body>
		<jsp:include page="template/USGSHeader.jsp">
			<jsp:param name="relPath" value="" />
			<jsp:param name="header-class" value="" />
			<jsp:param name="site-title" value="${project.name}: d3 Box Plot - ${project.version}" />
		</jsp:include>
		<div class="application-body">
			<h1>SVG Boxplot using d3.js!</h1>
			<div id="content">
				<div id="chart"></div>
