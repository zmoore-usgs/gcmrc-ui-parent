 ...
 * @author dmsibley
 */
public class CentralQWDownloadSpec extends Spec {
	...
	public String setupTableName() {
		...
		result.append("        s.start_date + 1/24 AS START_DT,");
		result.append("        s.end_date + 1/24 AS END_DT,");
	...
	public static final String S_START_DATE = "start time or mean time (CST)";
	public static final String S_END_DATE = "end time (CST)";
