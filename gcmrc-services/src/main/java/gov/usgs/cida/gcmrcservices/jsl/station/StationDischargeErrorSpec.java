...
public class StationDischargeErrorSpec extends GCMRCSpec {
	...
	public String setupTableName() {
		...
		result.append("      THEN 'dischargeObservation'");
		result.append("      ELSE 'dischargeMeasurement'"); 
		result.append("    END AS SAMPLE_METHOD,");
		result.append("    CASE");
		result.append("      WHEN LOWER(DED.METHOD) = 'observation' OR LOWER(DED.METHOD) = 'estimate'");
		...
		result.append("    CASE");
		result.append("      WHEN LOWER(DED.METHOD) = 'observation' OR LOWER(DED.METHOD) = 'estimate'");
		result.append("      THEN 'Discharge Error for Observations and Estimates'");
		result.append("      ELSE 'Discharge Error'"); 
		result.append("    END AS DISPLAY_NAME,");
