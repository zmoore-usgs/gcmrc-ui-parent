...
if (Dygraph.OPTIONS_REFERENCE) {
	Dygraph.OPTIONS_REFERENCE.gcmrcRangeSelector = Dygraph.OPTIONS_REFERENCE.showRangeSelector.clone();
}
...
Dygraph.Plugins.GCMRCRangeSelector = (function() {
	...
	rangeSelector.prototype.activate = function(dygraph) {
		...
		if (this.getOption_('gcmrcRangeSelector')) {
...
//------------------------------------------------------------------
	...
	rangeSelector.prototype.reserveSpace_ = function(e) {
		if (this.getOption_('gcmrcRangeSelector')) {
			e.reserveSpaceBottom(this.getOption_('rangeSelectorHeight') + 16); //TODO MAGIC NUMBER!!!!!
		}
	};
	...
	rangeSelector.prototype.updateVisibility_ = function() {
		var enabled = this.getOption_('gcmrcRangeSelector');
		if (enabled) {
	...
	rangeSelector.prototype.resize_ = function() {
		...
		this.canvasRect_ = {
			x: plotArea.x,
			y: plotArea.y + plotArea.h + xAxisLabelHeight + 16, //TODO MAGIC NUMBER!!!!!!!!!!!!!!!!!
			w: plotArea.w,
	...
	rangeSelector.prototype.initInteraction_ = function() {
		...
		toXDataWindow = function(zoomHandleStatus) {
			var xDataLimits = self.dygraph_.getOption("dateWindow") || self.dygraph_.xAxisExtremes();
...
//				}
	...
	rangeSelector.prototype.drawMiniPlot_ = function() {
		var dataGap =  2 * 24 * 60 * 60 * 1000; //172800000;
		...
		var dateWindow = this.getOption_('dateWindow');
	...
	rangeSelector.prototype.placeZoomHandles_ = function() {
		var xExtremes = this.getOption_('dateWindow') || this.dygraph_.xAxisExtremes();
