...
GCMRC.Page = {
	...
	downloadSamplesClicked : function() {
		...
		document.location = document.location.href.first(document.location.href.lastIndexOf('/') + 1) + CONFIG.relativePath + 'services/rest/qw/download/?' + $.param(serviceOptions);
	},
