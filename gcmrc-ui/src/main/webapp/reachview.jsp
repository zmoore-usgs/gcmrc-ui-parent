...
<!--[if gt IE 8]><!--> <html lang="en" class="no-js"> <!--<![endif]-->
    <head>
		...
		<script src="${relativePath}services/service/station/jsonp/param?site=${upstreamStationName}&site=${downstreamStationName}&jsonp_callback=GCMRC.Page.paramsLoad"></script>
					...
					<div class="span6" id="options-dygraph">
						<div class="innerRightSidebar">
							...
							<form class="form-horizontal">
								...
								<div id="build-div" style="text-align:center;"><a href="#" class="buildButton" id="buildGraph">Build Graph</a></div>
							</form>
						</div>
